...
namespace FingerPrint
{
    class GenerateWatermark
    {
        public Bitmap getWatermarkedImage(string path,byte[] hashcode)
        {
            ...
            //outputImagePath = @"C:\Users\Mihir Gajjar\Desktop\temp.png";
        ...
        //        outputImagePath = @"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\WaterMarkedImages\InnerHashInOuterImage\" + left.ToString() + "_" + right.ToString() + ".bmp";
        ...
        public void CreateWaterMarkImage(string[] share1, string[] share2, string foldername)
        {
            ...
            for (int i = 0; i < share1.Length; i++)
            {
                ...
                //watermarking WaterMarkedImages
                string outputImagePath;
                outputImagePath = @"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\WaterMarkedImages\" + foldername + "\\" + left.ToString() + "_" + right.ToString() + ".bmp";
                //Creating new watermarkerdimage
