...
namespace FingerPrint
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int TotalFiles = 30;
            int choice = 0;
            string parentDirectory = @"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\";
            string readFrom = "";
            string writeTo = "";
            ...
            for (int i = 0; i < TotalFiles / 10; i++)
            {
                for (int j = 1; j <= 10; j++)
                {
                    files[k] = @"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\Database\" + (i + 1).ToString() + "_" + j.ToString() + ".bmp";
                    outerImage[k] = @"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\Outer Images\" + (i + 1).ToString() + "_" + j.ToString() + ".bmp";
                    InnerImage[k] = @"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\Inner Images\ROI_" + (i + 1).ToString() + "_" + j.ToString() + ".png";
                    k++;
                }
            }
            ...
            byte[] hash1 = g.getSHAofAnImage(@"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\Inner Images\ROI_2_1.png");
            for (int j = 1; j <= 10; j++)
            {
                byte[] hash2 = g.getSHAofAnImage(@"C:\Users\Mihir Gajjar\Desktop\DSP_Final\FingerPrint\FingerPrint\Inner Images\ROI_2_" +j.ToString() +".png");
